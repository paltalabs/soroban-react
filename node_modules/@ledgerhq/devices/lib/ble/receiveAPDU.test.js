...
const receiveAPDU_1 = require("./receiveAPDU");
describe("receiveAPDU", () => {
    ...
    tests.forEach(({ input, expectedOutput }) => {
        test(`Input: ${JSON.stringify(input)} -> Expected output: ${JSON.stringify(expectedOutput)}`, done => {
            const rawStream = (0, rxjs_1.from)(input);
            (0, receiveAPDU_1.receiveAPDU)(rawStream).subscribe({
                error: error => {
...
//# sourceMappingURL=receiveAPDU.test.js.map