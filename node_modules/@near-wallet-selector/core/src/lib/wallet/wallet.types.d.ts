...
type BaseWallet<Type extends string, Metadata extends BaseWalletMetadata, Behaviour> = {
    /**
...
export type BrowserWalletBehaviour = Modify<BaseWalletBehaviour, {
...
export type BrowserWallet = BaseWallet<"browser", BrowserWalletMetadata, BrowserWalletBehaviour>;
...
export type InjectedWalletBehaviour = Modify<BaseWalletBehaviour, {
    buildImportAccountsUrl?(): string;
    importAccountsInSecureContext?(params: AccountImportSecureContextParams): Promise<void>;
}>;
export type InjectedWallet = BaseWallet<"injected", InjectedWalletMetadata, InjectedWalletBehaviour>;
...
export type InstantLinkWallet = BaseWallet<"instant-link", InstantLinkWalletMetadata, InstantLinkWalletBehaviour>;
...
export type HardwareWalletBehaviour = Modify<BaseWalletBehaviour, {
    signIn(params: HardwareWalletSignInParams): Promise<Array<Account>>;
}> & {
    getPublicKey(derivationPath: string): Promise<string>;
};
export type HardwareWallet = BaseWallet<"hardware", HardwareWalletMetadata, HardwareWalletBehaviour>;
...
export type BridgeWalletBehaviour = Modify<BaseWalletBehaviour, {
    signIn(params: BridgeWalletSignInParams): Promise<Array<Account>>;
}>;
export type BridgeWallet = BaseWallet<"bridge", BridgeWalletMetadata, BridgeWalletBehaviour>;
export type WalletMetadata = BrowserWalletMetadata | InjectedWalletMetadata | InstantLinkWalletMetadata | HardwareWalletMetadata | BridgeWalletMetadata;
export type Wallet = BrowserWallet | InjectedWallet | InstantLinkWallet | HardwareWallet | BridgeWallet;
...
export type WalletBehaviourFactory<Variation extends Wallet, ExtraOptions extends object = object> = (options: WalletBehaviourOptions<Variation> & ExtraOptions) => Promise<Omit<Variation, "id" | "type" | "metadata">>;
...
export type WalletModuleFactory<Variation extends Wallet = Wallet> = (options: WalletModuleOptions) => Promise<WalletModule<Variation> | null>;
export {};
